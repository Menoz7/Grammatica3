...
cond:                                             ; preds = %loop, %entry
  ...
  %subres = fsub double %y6, %z7
  %eps8 = load double, ptr %eps, align 8
  %lttest = fcmp ult double %subres, %eps8
  %z9 = load double, ptr %z, align 8
  %y10 = load double, ptr %y1, align 8
  %subres11 = fsub double %z9, %y10
  %eps12 = load double, ptr %eps, align 8
  %lttest13 = fcmp ult double %subres11, %eps12
  %and = and i1 %lttest13, %lttest
  %not = xor i1 %and, true
  br i1 %not, label %loop, label %merge
